    ...
    <footer className="pt-10 px-24 bg-themecolor mobile:max-sm:px-2">
      <div className="max-w-screen-xl mx-auto px-24 text-gray-600 md:px-4 mobile:max-sm:w-full">
          ...
          <div className="space-y-6">
            ...
            <ul className="flex flex-wrap text-slate-300 items-center gap-4 text-sm sm:text-base">
              {footerNavs.map((item, idx) => (
                <li
                  key={idx}
                  className="text-[#000] hover:text-gray-500 duration-150"
                >
          ...
          <div className="mt-6">
            ...
            <div className="flex items-center gap-3 mt-3 sm:block">
              <a href="javascript:void()">
                ...
                <button className="text-white border border-white rounded py-1 px-2 flex justify-between items-center gap-3">
        ...
        <div className="mt-10 py-10 border-t md:text-center">
          <p>© 2023 POCKERPLAY Inc. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
